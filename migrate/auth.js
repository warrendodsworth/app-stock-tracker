const { app, auth, db, messaging, adminsProd, printUser, UserService } = require('./main');
...
addGroupIdToUserGroups();

// Init
async function initAdmins() {
  const emails = ['warren.dodsworth@gmail.com', 'david@linkmate.com.au'];
...
async function restoreUserRecords() {
  // Accounts to restore - Hanh 'Tc98w6t2avcCJNrzGC5kuubdFsr2' - deleted himself
  // Marie 2x accounts in the db with the same email - mggermon1976@gmail.com
